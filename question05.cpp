...
class Shape {
public:
    Shape(const Point& center, std::string name): m_center(center), _name(name){}
    virtual size_t area() const {return 0;}
...
public:
    Circle(const Point& center, int radius) :
            Shape(center, "Circle"), radius(radius)
    {}
    size_t area() const {
